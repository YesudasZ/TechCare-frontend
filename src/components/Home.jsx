...
//               <button onClick={handleGetStarted} className="mt-6 bg-white text-black px-8 py-3 rounded-full text-lg hover:bg-gray-200 transition-all duration-300">
//       Get Started
//     </button>
//             </div>
//           </div>
...
//               className="text-xl md:text-2xl text-gray-300 mb-8"
//             >
//               Book expert home services at a moment's notice. We'll take care of the rest.
//             </motion.p>
//             <motion.button
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
...
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
//           <HowItWorksStep step="01" title="Choose Your Service" />
//           <HowItWorksStep step="02" title="Book an Expert" />
//           <HowItWorksStep step="03" title="Enjoy Quality Service" />
//         </div>
//       </section>

//       <section className="py-20 px-4">
//         <h2 className="text-4xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">Why Choose TechCare</h2>
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
//           <TrustFeature title="Time-Saving" icon={FiClock} />
//           <TrustFeature title="Safety First" icon={FiShield} />
//           <TrustFeature title="Top-Rated Professionals" icon={FiStar} />
//           <TrustFeature title="Fully Equipped" icon={FiCheck} />
//           <TrustFeature title="24/7 Support" icon={FiCheck} />
//           <TrustFeature title="Cashless Transactions" icon={FiCheck} />
//         </div>
//       </section>
//     </div>
//   );
