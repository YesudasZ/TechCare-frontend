...
//               <img
//                 src={selectedTechnician.aadharPicture}
//                 alt="Aadhar"
//                 style={{ width: "100%", marginTop: "8px" }}
//                 onClick={() =>
//                   handleImageClick(selectedTechnician.aadharPicture)
//                 }
//               />
//             </Box>
//             <Box sx={{ mt: 2 }}>
...
//               <img
//                 src={selectedTechnician.certificatePicture}
//                 alt="Certificate"
//                 style={{ width: "100%", marginTop: "8px" }}
//                 onClick={() =>
//                   handleImageClick(selectedTechnician.certificatePicture)
//                 }
//               />
//             </Box>
//             <Box
...
//                 src={selectedTechnician.aadharPicture}
//                 alt="Aadhar"
//                 style={{ width: "100%", height: "100px", marginTop: "8px" }} // Reduced size
//                 onClick={() =>
//                   handleImageClick(selectedTechnician.aadharPicture)
//                 }
//               />
...
//       {enlargedImage && (
//         <div
//           className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[9999]" // Increase z-index to be in front of modal
//           onClick={() => setEnlargedImage(null)}
//         >
//           <img
//             src={enlargedImage}
...
//             </Typography>
//             <Typography>Aadhar No: {selectedTechnician.aadharNo}</Typography>
//             {renderFilePreview("Aadhar Picture", selectedTechnician.aadharPicture)}
//             {renderFilePreview("Certificate Picture", selectedTechnician.certificatePicture)}
//             <Box
//               sx={{
//                 display: "flex",
//                 justifyContent: "space-between",
