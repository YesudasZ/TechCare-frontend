...
// import {
//   FiUser, FiMail, FiPhone, FiMapPin, FiLock, FiEdit2, FiTrash2, FiPlusCircle, FiAlertCircle
// } from 'react-icons/fi';
// import { updateUserProfile, updateUserPassword, updateUserAddress, getUserAddresses, deleteUserAddress, updateProfilePicture } from '../store/authSlice';
...
//         try {
//           setIsLoading(true);
//           const result = await dispatch(updateProfilePicture({ image: reader.result })).unwrap();
//           setProfileData((prevState) => ({
//             ...prevState,
...
//         } catch (error) {
//           setSnackbar({ open: true, message: error.message || 'Failed to update profile picture', severity: 'error' });
//         } finally {
//           setIsLoading(false);
//         }
//       };
...
//     setIsLoading(true);
//     try {
//       await dispatch(updateUserAddress(selectedAddress ? { ...newAddress, addressId: selectedAddress._id } : newAddress)).unwrap();
//       setSnackbar({ open: true, message: 'Address updated successfully', severity: 'success' });
//       setIsAddressModalOpen(false);
//       dispatch(getUserAddresses());
//     } catch (error) {
//       setSnackbar({ open: true, message: error.message || 'Failed to update address', severity: 'error' });
//     } finally {
//       setIsLoading(false);
//     }
//   };
...
//       } catch (error) {
//         setSnackbar({ open: true, message: error.message || 'Failed to delete address', severity: 'error' });
//       } finally {
//         setIsLoading(false);
...
//                 />
//                 <label htmlFor="profile-picture-upload" className="absolute bottom-0 right-0 bg-blue-500 rounded-full p-2 cursor-pointer">
...
//                 setNewAddress({street: '', city: '', state: '', country: '', postalCode: '', phoneNumber: ''});
//                 setIsAddressModalOpen(true);
//               }}
//             >
...
//       name={name}
//       id={name}
//       className="block w-full pl-10 pr-3 py-2 border border-gray-600 rounded-md leading-5 bg-gray-700 text-gray-300 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors duration-200"
//       placeholder={label}
//       value={value}
//       onChange={onChange}
//     />
